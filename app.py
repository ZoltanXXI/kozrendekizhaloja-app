...
def gpt_search_recipes(user_query):
    ...
    matched_preview = [{"title": r.get("title", ""), "excerpt": (r.get("full_text",""))} for r in top_matched]
        # Biztonságos készítés: mindig készítünk javaslatot és visszatérünk egy dict-tel
    try:
    ...
    # Általános javaslatok és elemzés (ugyanaz mindkét útvonalon)
    ...
    result = {
        ...
        "full_labels_preview": full_labels_preview
    }
    return result
